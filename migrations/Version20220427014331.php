 ...
 */
final class Version20220427014331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD datevalidation DATE DEFAULT NULL, ADD dateapprobation DATE DEFAULT NULL, ADD datearchivage DATE NOT NULL, CHANGE titre titre VARCHAR(255) DEFAULT NULL');
