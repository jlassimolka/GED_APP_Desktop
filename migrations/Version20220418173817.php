 ...
 */
final class Version20220418173817 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE categorie (id INT AUTO_INCREMENT NOT NULL, categoriedoc_id INT DEFAULT NULL, libcat VARCHAR(255) NOT NULL, description LONGTEXT NOT NULL, nom VARCHAR(255) NOT NULL, INDEX IDX_497DD634F61649F0 (categoriedoc_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('ALTER TABLE categorie ADD CONSTRAINT FK_497DD634F61649F0 FOREIGN KEY (categoriedoc_id) REFERENCES document (id)');
