 ...
 */
final class Version20220427173443 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD createur VARCHAR(255) DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT NULL, CHANGE datevalidation datevalidation DATE DEFAULT NULL, CHANGE dateapprobation dateapprobation DATE DEFAULT NULL, CHANGE datearchivage datearchivage DATE DEFAULT NULL');
