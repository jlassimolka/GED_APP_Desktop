 ...
 */
final class Version20220414195958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD archivage TINYINT(1) DEFAULT NULL, ADD validation TINYINT(1) DEFAULT NULL, ADD approbation TINYINT(1) DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT NULL');
