 ...
 */
final class Version20220422221746 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document DROP datevalidation, DROP dateapprobation, DROP datearchivage, CHANGE titre titre VARCHAR(255) DEFAULT NULL');
