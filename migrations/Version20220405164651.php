 ...
 */
final class Version20220405164651 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE document ADD version INT DEFAULT NULL, CHANGE titre titre VARCHAR(255) DEFAULT NULL');
