 ...
 */
final class Version20220318195019 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP flname, CHANGE roles roles JSON NOT NULL, CHANGE image image VARCHAR(255) NOT NULL');
